...
export const DashPlayer = ({ url, onPlayerReady }) => {
  ...
  async function likeVideo(event){
    ...
    axios.post('http://bubbleguppies.cse356.compas.cs.stonybrook.edu/api/like', {id: videoID, value: true })
  }
  async function dislikeVideo(event){
    let videoID = url.split("/").pop().split(".")[0] + ".mp4";
    console.log("THE VIDEO ID:", videoID);
      axios.post('http://bubbleguppies.cse356.compas.cs.stonybrook.edu/api/like', {id: videoID, value: false })
  }
